...
import com.qa.booma.exceptions.ElementException;
...
public class ElementUtil {
	...
	//own create method
	public void DoSelectValueFromDropDown1(By locator, String value) throws InterruptedException {
		...
		System.out.println("Option list size "+optionsList.size());
		System.out.println("Im dropdown without select class");
		for (WebElement e : optionsList) {
			String text = e.getText();
			if (text.equals(value)) {
				e.click();
	...
	public void getdroDownValues(By Locator, String value) throws InterruptedException
	{
		getElement(Locator).click();
		Thread.sleep(10000);
		nullBlankCheck(value);
...
//		  }
	...
	//own create method wait mechanisms
		public void DoSelectValueFromDropDownWait(By locator, String value) throws InterruptedException {
			
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			
		WebElement elemnts =	wait.until(ExpectedConditions.visibilityOfElementLocated((By) getElement(locator)));
	...
	public void DoSelectValueFromDropDownString(By locator, String value) throws InterruptedException {
		nullBlankCheck(value);
		// own 
		getElement(locator).click();
		Thread.sleep(3000);
